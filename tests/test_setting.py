...
from pickysettings.core.exceptions import (
    FieldInitializationError, setting as setting_exceptions)


@pytest.mark.usefixtures('settings_tmp_client')
class TestSetting:
    """
    Tests pertaining to the individual Setting objects that are stored for
    each setting provided to LazySettings.
    """
    ...
    def test_nonexisting_file(self):
        ...
        be raised.
        """
        self.create_temp_dir('Users/John/settings')
...
class TestLoadSetting:
    ...
    def test_converts_constants_to_fields(self, temp_module, test_setting):
...
class TestSettingGetPath:
    ...
    def test_filename_with_extension(self):
        ...
        self.create_temp_dir('app/settings')
        self.create_temp_file('dev.py', directory='app/settings')
    ...
    def test_treats_as_module_path(self):
        """
        ...
        """
        self.create_temp_dir('app/settings/deploy')
        self.create_temp_file('prod.py', directory='app/settings/deploy')
...
@pytest.mark.usefixtures('settings_tmp_client')
class TestSettingGetModulePath:
    """
    ...
    def test_folder_name_like_file(self):
        """
        ...
        directory = self.create_temp_dir('app/settings/dev.py')
    ...
    def test_path_appended_to_base_dir(self):
        """
    ...
    def test_path_relative_to_base_dir(self):
        """
        Setting value can be relative to the base directory.
        """
        self.create_temp_dir('app/settings/development')
        self.create_temp_file('dev.py', directory='app/settings/development')
...
@pytest.mark.usefixtures('settings_tmp_client')
class TestSettingGetAbsolutePath:
    """
    Tests pertaining to the .get_absolute_path() method of individual Setting objects
    that are stored for each setting provided to LazySettings.
    """

    def assertAbsPath(self, setting, path):
        absolute_path = setting.get_absolute_path()
        expected = os.path.join(str(self.tmpdir), path)

        expected_rel_path = pathlib.Path(expected).relative_to(self.tmpdir)
        absolute_rel_path = absolute_path.relative_to(self.tmpdir)
    ...
    def test_module_treated_as_path(self):
        """
        ...
        """
        self.create_temp_dir('app/settings/develop')
        self.create_temp_file('dev.py', directory='app/settings/develop')
    ...
    def test_without_extension(self):
        ...
        self.assertAbsPath(setting, 'app/settings/dev.py')
    ...
    def test_unsupported_filetype(self):
        ...
        self.create_temp_dir('app/settings')
        self.create_temp_file('dev.ini', directory='app/settings')
        ...
        # exists.
        self.create_temp_dir('app/settings/develop')
        self.create_temp_file('dev.abc', directory='app/settings/develop')
    ...
    def test_unknown_filetype(self):
        ...
        self.create_temp_dir('app/settings')
        self.create_temp_file('dev.uac', directory='app/settings')
    ...
    def test_path_overlaps_base_dir(self):
        """
    ...
    def test_path_relative_to_base_dir(self):
        ...
        base_path = pathlib.PosixPath('app/settings/development')
        setting = Setting('app/settings/development/dev.py', base_path=base_path)
        self.assertAbsPath(setting, 'app/settings/development/dev.py')
